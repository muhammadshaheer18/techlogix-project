...
class AccountDetailsPage {
  ...
  constructor() {
    ...
    this.activeTab = ko.observable('account'); // Default to account tab
    ...
    this.canProceed = ko.computed(() => {
      const isValid = this.activeTab() === 'account' ? 
  ...
  /**
   * Switch between Account Number and IBAN tabs
   */
  public switchTab = (tabName: string): void => {
    this.activeTab(tabName);
    this.hasError(false); // Clear any existing errors when switching tabs
    this.errorMessage('');
  };
  ...
  /**
   * Validate account number format and checksum
   */
  private validateAccountNumber(accountNumber: string): boolean {
    ...
    // For example: checksum validation, bank-specific rules, etc.
  ...
  public connected = (): void => {
    console.log('AccountDetails component connected');
  ...
  public disconnected = (): void => {
    console.log('AccountDetails component disconnected');
